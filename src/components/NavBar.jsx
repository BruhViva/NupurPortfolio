...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 px-4
     text-white bg-gradient-to-r from-black to-gray-950 fixed'>
        <div>
            <h1 className='text-5xl  font-semibold ml-2'> Nupur Jha</h1>
        </div>
        ...
        {links.map(({ id, link })=> (
            <li 
            key ={id} 
            className='px-4 cursor-pointer capitalize font-semibold
